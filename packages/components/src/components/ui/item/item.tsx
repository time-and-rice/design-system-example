...
const itemVariants = cva(
  "group/item flex flex-wrap items-center rounded-md border border-neutral-200 border-transparent text-sm outline-none transition-colors duration-100 focus-visible:border-neutral-950 focus-visible:ring-[3px] focus-visible:ring-neutral-950/50 dark:border-neutral-800 dark:focus-visible:border-neutral-300 dark:focus-visible:ring-neutral-300/50 [a]:transition-colors [a]:hover:bg-neutral-100/50 dark:[a]:hover:bg-neutral-800/50",
  {
    variants: {
      variant: {
...
function ItemDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "line-clamp-2 text-balance font-normal text-neutral-500 text-sm leading-normal dark:text-neutral-400",
